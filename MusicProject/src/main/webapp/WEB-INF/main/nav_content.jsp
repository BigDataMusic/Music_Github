...
<body>
	<div id="sidebar">
		<div class="logo_block" style="margin-bottom: 50px">
			<a href="#"><img src="resources/images/nav_content.png" alt="setalpm" width="190" height="156"/></a><br />
